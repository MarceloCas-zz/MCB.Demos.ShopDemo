...
public sealed class AddNewCustomerAddressInfoCustomerAddressInputShouldBeValidValidator
    : InputBaseValidator<AddNewCustomerAddressInfoCustomerAddressInput>,
    IAddNewCustomerAddressInfoCustomerAddressInputShouldBeValidValidator
{
    // Fields
    private readonly ICustomerAddressSpecifications _customerAddressSpecifications;

    // Constructors
    public AddNewCustomerAddressInfoCustomerAddressInputShouldBeValidValidator(
    ...
    // Protected Methods
    protected override void ConfigureFluentValidationConcreteValidatorInternal(ValidatorBase<AddNewCustomerAddressInfoCustomerAddressInput>.FluentValidationValidatorWrapper fluentValidationValidatorWrapper)
    {
